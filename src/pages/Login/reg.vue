		...
		<div class="container">
			<div class='regContainer'>
			  	<div class='regInfo'>
				    ...
				    <div><span>车宽（米）</span><input placeholder='车宽'  type="number"    ref="vehicleWide"   @keyup.enter="getFocus('vehicleHeight')"    v-model='vehicleWide'></input><i v-if="vehicleWide.length" @click="clearInput('vehicleWide')" class="iconfont icon-iconfontcuowu"></i></div>
				    <div><span>车高（米）</span><input placeholder='车高'  type="number"   ref="vehicleHeight"   @keyup.enter="getFocus('maxLoadWeight')"    v-model='vehicleHeight'></input><i v-if="vehicleHeight.length" @click="clearInput('vehicleHeight')" class="iconfont icon-iconfontcuowu"></i></div>
				    <div><span>载重（吨）</span><input placeholder='必填'  type="number"    ref="maxLoadWeight"   @keyup.enter="getFocus('maxLoadVolumn')"    v-model='maxLoadWeight'></input><i v-if="maxLoadWeight.length" @click="clearInput('maxLoadWeight')"  class="iconfont icon-iconfontcuowu"></i></div>
				    <div><span>载重体积(方)</span><input placeholder='必填' type="number"   ref="maxLoadVolumn"   @keyup.enter="regBtn"    v-model='maxLoadVolumn'></input><i v-if="maxLoadVolumn" @click="clearInput('maxLoadVolumn')" class="iconfont icon-iconfontcuowu"></i></div>
