<template>
	<div class="Violation">
	    <header><i class="iconfont icon-xiangzuo1"  @click="goPrev"></i><span class="title_text">维修</span></header>
        ...
        AMap.plugin('AMap.Geolocation', function() {
            ...
            geolocation.getCurrentPosition(function(status,result){
	            ...
	            AMap.service(["AMap.PlaceSearch"], function() {
			        ...
			        placeSearch.searchNearBy('汽车维修', cpoint, 100000, function(status, result) {
