<template>
    <div class="FillingStation">
        <header><i class="iconfont icon-xiangzuo1"  @click="goPrev"></i><span class="title_text">加油</span></header>
        ...
        AMap.plugin('AMap.Geolocation', function() {
            ...
            geolocation.getCurrentPosition(function(status,result){
	            ...
	            AMap.service(["AMap.PlaceSearch"], function() {
			        ...
			        placeSearch.searchNearBy('加油站', cpoint, 100000, function(status, result) {
